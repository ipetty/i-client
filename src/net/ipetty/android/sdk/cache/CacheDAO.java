...
public class CacheDAO {
	...
	public void insert(CacheEntry e) {
		...
		SQLiteDatabase db = helper.getWritableDatabase();
		Log.d(TAG, "save:" + sql);
		db.execSQL(sql, new Object[] { e.getId(), e.getUrl(), e.getValue(), e.getEtag(), e.getExpireOn(), e.getHits(),
				System.currentTimeMillis(), e.getClassType() });
	}
	...
	private CacheEntry toEntry(String url, String value, String etag, Long expire_on, String classType, Long hits,
			Long put_on) {
