...
public class UserApiImpl extends ApiBase implements UserApi {
	...
	public boolean checkEmailAvailable(String email) {
		return getRestTemplate().getForObject(buildUri(URI_CHECK_EMAIL_AVAILABLE, "email", email), Boolean.class);
	}
	...
	public UserStatisticsVO getUserStatisticsByUserId(Integer userId) {
		return getRestTemplate().getForObject(Constant.API_SERVER_BASE + URI_GET_USER_STATISTICS_BY_USER_ID,
	...
	public boolean isFollow(Integer friendId) {
		...
		MultiValueMap<String, String> request = new LinkedMultiValueMap<String, String>();
		request.set("friendId", String.valueOf(friendId));
		return getRestTemplate().getForObject(buildUri(URI_IS_FOLLOW, request), Boolean.class);
	}
