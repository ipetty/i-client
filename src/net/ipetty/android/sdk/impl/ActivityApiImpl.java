...
public class ActivityApiImpl extends ApiBase implements ActivityApi {
	...
	public List<ActivityVO> listNewFansActivities() {
		...
		return Arrays.asList(getRestTemplate().getForObject(Constant.API_SERVER_BASE + URI_LIST_NEW_FANS_ACTIVITIES,
				ActivityVO[].class));
	}
	...
	public List<ActivityVO> listNewRepliesActivities() {
		...
		return Arrays.asList(getRestTemplate().getForObject(Constant.API_SERVER_BASE + URI_LIST_NEW_REPLIES_ACTIVITIES,
				ActivityVO[].class));
	}
	...
	public List<ActivityVO> listNewFavorsActivities() {
		...
		return Arrays.asList(getRestTemplate().getForObject(Constant.API_SERVER_BASE + URI_LIST_NEW_FAVORS_ACTIVITIES,
				ActivityVO[].class));
	}
