...
public class MainHomeFragment extends Fragment {
	...
	private final OnClickListener takePhotoClick = new OnClickListener() {
		@Override
		public void onClick(View v) {
			MainHomeFragment.this.mImageName = (System.currentTimeMillis() + ".jpg");
			Log.i(TAG, "takePhotoClick->mImageName:" + mImageName);
	...
	private final OnClickListener pickPhotoClick = new OnClickListener() {
		...
		public void onClick(View v) {
			MainHomeFragment.this.mImageName = (System.currentTimeMillis() + ".jpg");
			Log.i(TAG, "pickPhotoClick->mImageName:" + mImageName);
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == DeviceUtils.REQUEST_CODE_TAKE_IMAGE) {
			if (resultCode == FragmentActivity.RESULT_OK) {
				Log.i(TAG, "-->file path:" + this.mImageName);
				Log.i(TAG, "onActivityResult-->file path:" + PathUtils.getCarmerDir() + "," + this.mImageName);
