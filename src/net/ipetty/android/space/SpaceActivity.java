    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new GetUserStatisticsByUserId(this)
                .setListener(new DefaultTaskListener<UserStatisticsVO>(SpaceActivity.this) {
                    ...
                    public void onSuccess(UserStatisticsVO result) {
                        feed_num_text.setText(result.getFeedNum());
                        follow_num_text.setText(result.getFollowerNum());
                        fan_num_text.setText(result.getFollowerNum());
        ...
        fans.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (SpaceActivity.this.isCurrentUser) {
                    intent.putExtra("id", SpaceActivity.this.currUserId);
                } else {
                    intent.putExtra("id", SpaceActivity.this.userId);
                }
